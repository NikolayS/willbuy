/**
 * Temporary dogfood runner for visitor-worker (not committed — delete after #86 completes).
 */
import { Pool } from 'pg';
import { LocalCliProvider } from '@willbuy/llm-adapter';
import { runVisitorPollingLoop } from '../apps/visitor-worker/src/poller.ts';
